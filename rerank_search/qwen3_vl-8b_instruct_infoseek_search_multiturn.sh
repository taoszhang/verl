...
python3 -m verl.trainer.main_ppo \
    ...
    data.custom_cls.path=$PROJECT_DIR/rerank_search/infoseek/infoseek_instruct_dataset.py \
    data.custom_cls.name=InfoseekRLHFDataset \
    custom_reward_function.path=$PROJECT_DIR/rerank_search/infoseek/infoseek_instruct_rm.py \
    custom_reward_function.name=compute_score \
    actor_rollout_ref.rollout.multi_turn.format=instruct \
